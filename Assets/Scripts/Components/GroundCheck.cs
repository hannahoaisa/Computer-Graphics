...
public class GroundCheck : MonoBehaviour
{
    ...
    Vector3 RaycastOrigin => transform.position + changeGravity.up * OriginOffset;
    ...
    void LateUpdate()
    {
        ...
        bool isGroundedNow = Physics.Raycast(RaycastOrigin, -changeGravity.up, distanceThreshold * 2);
