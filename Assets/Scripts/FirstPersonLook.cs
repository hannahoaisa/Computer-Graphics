...
public class FirstPersonLook : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        transform.localRotation = Quaternion.AngleAxis(-velocity.y, changeGravity.right);       // Works perfectly (I think)
        ...
        //character.localRotation = Quaternion.AngleAxis(velocity.x, changeGravity.up);         // Messes literally everything up
    }
}
